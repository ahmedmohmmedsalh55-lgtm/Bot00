...
function bot($method,$datas=[]){
    $url = "https://bot00-1.onrender.com".API_KEY."/".$method;
    $ch = curl_init();
...
";
$admin = "6875188091";//ايديك
$tokensim="https://github.com";//توكن الموقع
$ch="huvfth";//معرف قناتك بدون @
...
'reply_markup'=>json_encode([
    'inline_keyboard'=>[
[['text'=>"إشتراك 📢",'url'=>"http://t.me/armof"],['text'=>" القائمة الرئيسية 🔙",'callback_data'=>"back"]],
    ] 
   ])
  ]);
 }
...
'reply_markup'=>json_encode([
    'inline_keyboard'=>[
[['text'=>"اضغط هنا",'url'=>"https://t.me/armof"],['text'=>" القائمة الرئيسية 🔙",'callback_data'=>"back"]],
    ] 
   ])
  ]);
 }
